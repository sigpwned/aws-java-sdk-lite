...
class URLEncodedUtils {
  ...
  /**
   * Returns a String that is suitable for use as an {@code application/x-www-form-urlencoded} list
   * of parameters in an HTTP PUT or HTTP POST.
   *
   * @param parameters The parameters to include.
   * @param charset The encoding to use.
   * @return An {@code application/x-www-form-urlencoded} string
   */
  public static String format(final List<? extends Map.Entry<String, String>> parameters,
   ...
   * @since 4.2
   */
  public static String format(final Iterable<? extends Map.Entry<String, String>> parameters,
  ...
  /**
   * Characters which are safe to use in userinfo, i.e. {@link #UNRESERVED} plus
   * {@link #PUNCT}uation
   */
  ...
  /**
   * Characters which are safe to use in a query or a fragment, i.e. {@link #RESERVED} plus
   * {@link #UNRESERVED}
   */
   ...
   * <a href="http://www.ietf.org/rfc/rfc2396.txt">RFC 2396</a> as augmented by
   ...
   * <p>
   * Uses the {@link #URLENCODER} set of characters, rather than the {@link #UNRSERVED} set; this is
   * for compatibilty with previous releases, URLEncoder.encode() and most browsers.
   *
  ...
  private static String encodeFormFields(final String content, final String charset) {
    ...
    return urlEncode(content, charset != null ? Charset.forName(charset) : StandardCharsets.UTF_8,
        URLENCODER, true);
  }
