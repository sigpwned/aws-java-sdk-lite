...
import static com.sigpwned.aws.sdk.lite.core.thirdparty.com.amazonaws.util.BinaryUtils.copyBytesFrom;
...
public class StringUtils {
  ...
  // Remove these methods to avoid the JodaTime dependency
  ...
  /**
   * Base64 encodes the data in the specified byte buffer (from the current position to the buffer's
   * limit) and returns it as a base64 encoded string.
   *
  ...
  public static String fromByteBuffer(ByteBuffer byteBuffer) {
    return Base64.getEncoder().encodeToString(copyBytesFrom(byteBuffer));
  }
