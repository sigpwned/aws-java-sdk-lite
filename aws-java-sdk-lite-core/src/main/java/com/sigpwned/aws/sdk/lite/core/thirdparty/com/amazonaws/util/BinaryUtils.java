 ...
 *
 * Portions copyright 2006-2009 James Murty. Please see LICENSE.txt for applicable license terms and
...
public class BinaryUtils {
  ...
  /**
   * Wraps a ByteBuffer in an InputStream. If the input {@code byteBuffer} is null, returns an empty
   * stream.
   *
   ...
   * account for the position of the input <code>ByteBuffer</code>. The opposite is typically true,
   * however, when handling <code>ByteBuffer</code> from withint the unmarshallers of the low-level
   * clients.
   */
