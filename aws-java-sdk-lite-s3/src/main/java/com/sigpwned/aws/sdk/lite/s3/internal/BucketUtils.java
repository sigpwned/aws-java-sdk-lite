 ...
 * ==================================LICENSE_END===================================
 */
package com.sigpwned.aws.sdk.lite.s3.internal;
...
/**
 * Utilities for working with Amazon S3 bucket names, such as validation and checked to see if they
 * are compatible with DNS addressing.
 *
 * See software.amazon.awssdk.services.s3.internal.BucketUtils
 */
public final class BucketUtils {
  ...
  /**
   * Validates that the specified bucket name is valid for Amazon S3 V2 naming (i.e. DNS addressable
   * in virtual host style). Throws an IllegalArgumentException if the bucket name is not valid.
   * <p>
   ...
   *         guidelines.
   */
  public static boolean isValidDnsBucketName(final String bucketName, final boolean throwOnError) {
   ...
   *
   * @param bucketName The bucket name to validate.
   * @param throwOnError boolean to decide if an error should be thrown if the bucket name doesn't
  ...
  /**
   * If 'exception' is true, throw an IllegalArgumentException with the given message. Otherwise,
